...
string(REPLACE "/lib/cmake/CGAL" "" CGAL_INSTALL_PREFIX "${CGAL_CONFIG_DIR}")
 ...
 if(NOT EXISTS "${CGAL_INSTALL_PREFIX}/lib/cmake/CGAL/CGALConfig.cmake")
    ...
    set(CGAL_INSTALL_PREFIX "E:/Libraries/Install/CGAL")
 endif()
...
set(CGAL_SUPPORTING_3RD_PARTY_LIBRARIES "GMP;MPFR;ZLIB;OpenGL;LEDA;MPFI;RS;RS3;OpenNL;Eigen3;BLAS;LAPACK;ESBTL;Coin3D;NTL;IPE")
...
if (NOT CGAL_IGNORE_PRECONFIGURED_GMP)
  set( GMP_FOUND           "TRUE")
  set( GMP_USE_FILE        "" )
  set( GMP_INCLUDE_DIR     "E:/Libraries/CGAL-4.14.2/auxiliary/gmp/include" )
  set( GMP_LIBRARIES       "E:/Libraries/CGAL-4.14.2/auxiliary/gmp/lib/libgmp-10.lib" )
  set( GMP_DEFINITIONS     "" )
endif()
...
if (NOT CGAL_IGNORE_PRECONFIGURED_MPFR)
  set( MPFR_FOUND           "TRUE")
  set( MPFR_USE_FILE        "" )
  set( MPFR_INCLUDE_DIR     "E:/Libraries/CGAL-4.14.2/auxiliary/gmp/include" )
  set( MPFR_LIBRARIES       "E:/Libraries/CGAL-4.14.2/auxiliary/gmp/lib/libmpfr-4.lib" )
...
if (NOT CGAL_IGNORE_PRECONFIGURED_ZLIB)
  set( ZLIB_FOUND           "TRUE")
  set( ZLIB_USE_FILE        "" )
  set( ZLIB_INCLUDE_DIR     "E:/Libraries/Install/zlib/include" )
  set( ZLIB_LIBRARIES       "optimized;E:/Libraries/Install/zlib/lib/zlib.lib;debug;E:/Libraries/Install/zlib/lib/zlibd.lib" )
...
if (NOT CGAL_IGNORE_PRECONFIGURED_Eigen3)
  ...
  set( EIGEN3_INCLUDE_DIR     "E:/Libraries/Install/eigen-3.3.8" )
