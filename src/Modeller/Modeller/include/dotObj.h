...
public:
	...
	void exportToFileSegmentedPerLine(std::string fileType, std::string fileName);
	...
	std::vector<int> getBrachesToDeleteBasedOnPathSize(std::vector<std::vector<int>> &paths, std::vector<std::vector<int>> &neighboursPerVertex, int lim);
