...
bool dotObj::checkIfPointisInsidev2(Vector3f point) {  //Test this // LOL!!
	this->getBoundingBox();
	float maxside = fmax(fmax(this->boundingBox.maxX - this->boundingBox.minX, this->boundingBox.maxY - this->boundingBox.minY), this->boundingBox.maxZ - this->boundingBox.minZ);
